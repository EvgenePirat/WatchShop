                ...
                <div className="fz-offcanvas-main-sideinfo-section">
                    ...
                    <div className="fz-offcanvas-main-sideinfo">
                            ...
                            <ul className="fz-offcanvas-main-contacts-list">
                                ...
                                <li>
                                    ...
                                    <span className="fz-offcanvas-main-contact-text">
                                        <Link to="tel:(+1)909-407-2988">(+1) 909-407-2988</Link> <br />
                        ...
                        <div className="fz-offcanvas-main-socials mt-45">
                            <Link to="#"><i className="fa-brands fa-facebook-f"></i><i className="fa-brands fa-facebook-f"></i></Link>
                            <Link to="#"><i className="fa-brands fa-twitter"></i><i className="fa-brands fa-twitter"></i></Link>
                            <Link to="#"><i className="fa-brands fa-instagram"></i><i className="fa-brands fa-instagram"></i></Link>
                            <Link to="#"><i className="fa-brands fa-youtube"></i><i className="fa-brands fa-youtube"></i></Link>
                        </div>
